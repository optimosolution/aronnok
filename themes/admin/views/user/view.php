                ...
                <div class="user-profile row-fluid">
                    <div class="tabbable">
                        <ul class="nav nav-tabs padding-18">
                            ...
                            <li>
                                <a data-toggle="tab" href="#Reservation">
                                    <i class="orange icon-signal bigger-120"></i>
                                    Reservation
                                </a>
                            </li>
                            ...
                            <div id="Reservation" class="tab-pane">
                                <div class="row-fluid">
                                    <div class="span12">
                                        ...
                                        $this->widget('bootstrap.widgets.TbGridView', array(
                                            'id' => 'reservation-grid',
                                            'dataProvider' => $model_reservation->search_user($model->id),
                                            'filter' => $model_reservation,
                                            'columns' => array(
                                                array(
                                                ...
                                                array(
                                                    ...
                                                    'filter' => CHtml::activeDropDownList($model_reservation, 'status', CHtml::listData(ReservationStatus::model()->findAll(array('condition' => '', "order" => "title")), 'id', 'title'), array('empty' => 'All')),
                                                ...
                                                array(
                                                    ...
                                                    'buttons' => array
                                                        ...
                                                        'update' => array
                                                            ...
                                                            'options' => array('class' => 'edit', 'target' => '_blank'),
                                                        ),
                                                        'delete' => array
                                                            (
                                                            'label' => 'Delete',
                                                            'url' => 'Yii::app()->createUrl("reservation/delete", array("id"=>$data["id"]))',
                                        ...
                                        ?>
                                        <?php echo CHtml::link('New Reservation', array('reservation', 'id' => $model->id), array('class' => 'btn btn-primary', 'target' => '_blank')); ?>
                                    </div><!-- /span -->
                                </div><!-- /row -->
                            </div><!-- /#Reservation -->
                        </div>
