...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('adults_per_room')); ?>:</b>
	<?php echo CHtml::encode($data->adults_per_room); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('kids_per_room')); ?>:</b>
	<?php echo CHtml::encode($data->kids_per_room); ?>
	<br />
