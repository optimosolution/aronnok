...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textArea($model,'special_requests',array('rows'=>6, 'cols'=>50)); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'adults_per_room'); ?>
		<?php echo $form->textField($model,'adults_per_room'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'kids_per_room'); ?>
		<?php echo $form->textField($model,'kids_per_room'); ?>
	</div>
