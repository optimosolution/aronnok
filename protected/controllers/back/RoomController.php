    ...
    public function actionCreate() {
        ...
        if (isset($_POST['Room'])) {
            ...
            if ($model->validate()) {
                ...
                if (@!empty($_FILES['Room']['name']['picture'])) {
                    $model->picture = $_POST['Room']['picture'];
                ...
                if ($model->save()) {
                    Yii::app()->user->setFlash('success', 'Room has been created successfully');
    ...
    public function actionUpdate($id) {
        ...
        if (isset($_POST['Room'])) {
            ...
            if ($model->validate()) {
                ...
                if ($model->save()) {
                    Yii::app()->user->setFlash('success', 'Room has been saved successfully');
                    $this->redirect(array('admin'));
                }
            }
        }
