...
class ResortController extends BackEndController {
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['Resort'])) {
            $model->attributes = $_POST['Resort'];
            if ($model->validate()) {
                //Picture upload script
                if (@!empty($_FILES['Resort']['name']['picture'])) {
                    $model->picture = $_POST['Resort']['picture'];
                ...
                if ($model->save()) {
                    Yii::app()->user->setFlash('success', 'Resort has been created successfully');
    ...
    public function actionUpdate($id) {
        ...
        if (isset($_POST['Resort'])) {
            ...
            if ($model->validate()) {
                ...
                if ($model->save()) {
                    Yii::app()->user->setFlash('success', 'Resort has been saved successfully');
                    $this->redirect(array('admin'));
                }
            }
        }
    ...
    public function actionIndex() {
        $dataProvider = new CActiveDataProvider('Resort');
     ...
     * @return Resort the loaded model
     * @throws CHttpException
     */
    public function loadModel($id) {
        $model = Resort::model()->findByPk($id);
        if ($model === null) {
     ...
     * @param Resort $model the model to be validated
     */
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'resort-form') {
