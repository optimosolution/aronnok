...
class UserController extends BackEndController {
    ...
    public function accessRules() {
        return array(
            ...
            array('allow', // allow authenticated user to perform 'create' and 'update' actions
                'actions' => array('admin', 'create', 'update', 'view', 'edit', 'reservation'),
                'users' => array('@'),
            ),
    ...
    public function actionReservation($id) {
        ...
        $model->status = 1;
        if ($model->save()) {
            Yii::app()->user->setFlash('success', 'Reservation has been created successfully!');
            $this->redirect(array('/reservation/view', 'id' => $model->id));
        }
    }
    ...
    public function actionView($id) {
        ...
        //Reservation
        $model_reservation = new Reservation('search_user');
        $model_reservation->unsetAttributes();  // clear any default values
        if (isset($_GET['Reservation'])) {
            $model_reservation->attributes = $_GET['Reservation'];
        }
