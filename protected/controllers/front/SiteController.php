...
class SiteController extends Controller {
    ...
    public function actionIndex() {
        ...
        Yii::app()->clientScript->registerMetaTag(Yii::app()->name . ' - Mirror that reflects beautiful Bangladesh.', 'description');
        Yii::app()->clientScript->registerMetaTag("Aronnok Holiday Resort,rangamati,resort,hotel,bangladesh,beautiful Bangladesh,Kaptai Lake,Chittagong Hill Tracts,Chittagong,Aronnok,Resort in Bangladesh, Bangladeshi resort, Resorts in Bangladesh, Resort of Bangladesh, Resorts of Bangladesh, Bangladeshi resorts, Resort bangladesh, Resorts bangladesh, bangladeshi all resorts list, Best resorts in Bangladesh", 'keywords');
