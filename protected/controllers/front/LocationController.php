...
class LocationController extends Controller {
    ...
    public function accessRules() {
        return array(
            array('allow', // allow all users to perform 'index' and 'view' actions
                'actions' => array('index', 'view', 'resort', 'room'),
                'users' => array('*'),
            ),
    ...
    public function actionResort() {
        ...
        $criteria->select = '*';
        $criteria->addCondition('location=' . $_GET['id']);
        $criteria->order = 'resort ASC';

        $dataProvider = new CActiveDataProvider('Resort', array(
            'criteria' => $criteria,
            'pagination' => false,
        ));
    ...
    public function actionRoom() {
        $criteria = new CDbCriteria;
        $criteria->select = '*';
        $criteria->addCondition('resort=' . $_GET['id']);
